...
defaults = {'total_latency', 15, 'type_x', fi_dtype(1,18,17), 'acc_len', 14};
...
% round inputs
[x_mean_re, x_mean_re_dtype]         = round_to_wordlength_fi('round1', x_mean_re, 25, m_x_dtype);
[x_mean_im, x_mean_im_dtype]         = round_to_wordlength_fi('round2', x_mean_im, 25, m_x_dtype);
[x_sq_mean_re, x_sq_mean_re_dtype ]  = round_to_wordlength_fi('round3', x_sq_mean_re, 35, x_sq_dtype);
[x_sq_mean_im, x_sq_mean_im_dtype ]  = round_to_wordlength_fi('round4', x_sq_mean_im, 35, x_sq_dtype);
[abs_x_sq_mean, abs_x_sq_mean_dtype] = round_to_wordlength_fi('round5', abs_x_sq_mean, 35, x_sq_dtype);
[x_3rd_mean_re, x_3rd_mean_re_dtype] = round_to_wordlength_fi('round6', x_3rd_mean_re, 35, x_3rd_dtype);
[x_3rd_mean_im, x_3rd_mean_im_dtype] = round_to_wordlength_fi('round7', x_3rd_mean_im, 35, x_3rd_dtype);
