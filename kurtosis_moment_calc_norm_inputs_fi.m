...
% denominator
den = kurtosis_den(abs_x_sq_mean_del, abs_mx_sq, 'bit_width', bit_width_den, 'abs_m_x_sq_dtype', abs_m_x_sq_dtype, 'abs_x_sq_mean_del_dtype', x_sq_type, 'logging', logging);
