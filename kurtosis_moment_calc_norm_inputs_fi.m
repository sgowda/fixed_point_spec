...
% round inputs
[x_mean_re, x_mean_re_dtype]         = round_to_wordlength_fi('round1', x_mean_re, 25);
[x_mean_im, x_mean_im_dtype]         = round_to_wordlength_fi('round2', x_mean_im, 25);
[x_sq_mean_re, x_sq_mean_re_dtype ]  = round_to_wordlength_fi('round3', x_sq_mean_re, 25);
[x_sq_mean_im, x_sq_mean_im_dtype ]  = round_to_wordlength_fi('round4', x_sq_mean_im, 25);
[abs_x_sq_mean, abs_x_sq_mean_dtype] = round_to_wordlength_fi('round5', abs_x_sq_mean, 25);
[x_3rd_mean_re, x_3rd_mean_re_dtype] = round_to_wordlength_fi('round6', x_3rd_mean_re, 25);
[x_3rd_mean_im, x_3rd_mean_im_dtype] = round_to_wordlength_fi('round7', x_3rd_mean_im, 25);
...
% cross-products
[d, f, a, c, b, abs_mx_sq, e, h] = kurtosis_cross_products(x_mean_re, x_mean_im, X_sq_mean_re, X_sq_mean_im, abs_X_sq_mean, abs_X_4th_mean, X_3rd_mean_re, X_3rd_mean_im, 'total_latency', cross_product_latency, 'type_x', type_x);
...
function [d, f, a, c, b, abs_mx_sq, e, abs_mean_x_sq] = kurtosis_cross_products(x_mean_re, x_mean_im, X_sq_mean_re, X_sq_mean_im, abs_X_sq_mean, abs_X_4th_mean, X_3rd_mean_re, X_3rd_mean_im, varargin)
defaults = {'total_latency', 15, 'type_x', fi_dtype(1,18,17)};
type_x = get_var('type_x', 'defaults', defaults, varargin{:});
total_latency = get_var('total_latency', 'defaults', defaults, varargin{:});
[m_x_dtype, x_sq_dtype, x_3_dtype, x_4th_type] = kurtosis_acc_rounding_types(type_x);
...
[gamma, gamma_dtype] = mult_fi('mult6', X_3rd_mean_re, x_mean_re, 'latency', 6, 'type_a', x_3_dtype, 'type_b', m_x_dtype);
[delta, delta_dtype] = mult_fi('mult7', X_3rd_mean_im, x_mean_im, 'latency', 6, 'type_a', x_3_dtype, 'type_b', m_x_dtype);
